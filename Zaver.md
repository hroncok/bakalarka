...
Naimplementoval jsem repozitář Dapi, který umožňuje sdílet asistenty ve formátu dap. Jednotlivé dapy lze vyhledávat, procházet a stahovat. Dapi obsahuje API pro možnou integraci do apliakce DevAssistant. Instance Dapi je nasazena v cloudu na adrese `http://dapi.devassistant.org` a připravena na používání uživateli.
